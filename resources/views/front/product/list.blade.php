                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    <div class="product-grid">
                        ...
                        <div class="product-content">
                            <h3 class="title">
                                <a href="{{\App\Extensions\Util::to('/product/' . $product['id'] . '/' . $product['country'])}}">{{ str_limit($product['title'], 20,'...')  }}</a>
                            </h3>
                            <div class="price">{{$product['country']}}</div>
                            <div class="price" style="cursor: pointer">
                                <a index="{{\App\Extensions\Util::to('/product/' . $product['id'] . '/' . $product['country'])}}" onclick="copyUrl(this)">copy link</a>
                            </div>
                            <ul class="rating">
                            ...
                            <a class="add-to-cart" href="{{\App\Extensions\Util::to('/product/' . $product['id'] . '/' . $product['country'])}}">
...
<script language="javascript">
    function copyUrl(e)
    {
        ...
        input.setAttribute('value', e.getAttribute('index'));
        input.select();
